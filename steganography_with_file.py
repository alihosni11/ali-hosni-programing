...
def image_hidden_message_encoding(image, hidden_message_file, display ):
    
    with open(hidden_message_file, "r") as message_file:
...
txt_file_path = input("Enter txt file path:\n")

image_file_path = input("Enter Image File Path:\n")

display = input("Type yes to display encoded message length and encoded message:\n")

image_hidden_message_encoding(image_file_path, txt_file_path, display)